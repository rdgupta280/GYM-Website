      ...
      <div className={styles.second_section}>
        <div className={styles.second_text}>
          ...
          <ul>
            ...
            <p>
              Plus Fitness franchisee Jacob Awad first started his journey with
              the brand in 2020 after purchasing Plus Fitness Seven Hills from a
              previous owner.
            </p>
            <li> workout faculitis</li>
            <p>
              Knowledgeable and friendly staff can make your gym experience more
